...
class HybridEmbedderGrpcClient:
    ...
    async def embed_text(
        ...
        request = hybrid_embedder_pb2.EmbedRequest(text=text, normalize=normalize)
        GrpcTools.validate_proto(request)
    ...
    async def embed_batch(
        ...
        for i in range(0, len(valid_texts), self.batch_size):
            ...
            request = hybrid_embedder_pb2.EmbedBatchRequest(texts=batch_texts, normalize=normalize)
