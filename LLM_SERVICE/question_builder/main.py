...
from src.grpc.grpc_server import GrpcQuestionBuilderServer
...
class Service:
    def __init__(self) -> None:
        ...
        self.grpc_runner = GrpcQuestionBuilderServer()
    ...
    async def run_service(self) -> None:
        ...
        waiter = asyncio.create_task(self.grpc_runner.wait_terminated(), name="gRPC-QuestionBuilder")
