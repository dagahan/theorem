...
from src.grpc.grpc_server import GrpcRagOrchestratorServer
...
class Service:
    def __init__(self) -> None:
        ...
        self.grpc_runner = GrpcRagOrchestratorServer()
    ...
    async def run_service(self) -> None:
        ...
        waiter = asyncio.create_task(self.grpc_runner.wait_terminated(), name="gRPC-RagOrchestrator")
