...
class GRPCServerRunner:
    def __init__(self) -> None:
        self._system_prompt_builder_service = SystemPromptBuilderService()
        self._servicer = SystemPromptBuilderAPI(self._system_prompt_builder_service)
        self._max_workers: int = 4
        self._host: str = EnvTools.get_service_host("system_prompt_builder")
        self._port: int = int(EnvTools.get_service_grpc_port("system_prompt_builder"))
        ...
        system_prompt_builder_pb2_grpc.add_SystemPromptBuilderServiceServicer_to_server(self._servicer, self._server)
