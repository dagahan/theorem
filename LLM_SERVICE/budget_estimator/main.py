...
from src.grpc.grpc_server import GrpcBudgetEstimatorServer
...
class Service:
    def __init__(self) -> None:
        ...
        self.grpc_runner = GrpcBudgetEstimatorServer()
    ...
    async def run_service(self) -> None:
        ...
        waiter = asyncio.create_task(self.grpc_runner.wait_terminated(), name="gRPC-Policy-Builder")
