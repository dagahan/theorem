...
class LLMGatewayServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Health = channel.unary_unary(
                '/llm_gateway.v1.LLMGatewayService/Health',
...
def add_LLMGatewayServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'llm_gateway.v1.LLMGatewayService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('llm_gateway.v1.LLMGatewayService', rpc_method_handlers)
...
class LLMGatewayService(object):
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/llm_gateway.v1.LLMGatewayService/Health',
            llm__gateway__pb2.HealthRequest.SerializeToString,
            llm__gateway__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
