...
from src.grpc.grpc_server import GrpcHybridEmbedderServer
...
class Service:
    def __init__(self) -> None:
        ...
        self.grpc_runner = GrpcHybridEmbedderServer()
    ...
    async def run_service(self) -> None:
        ...
        waiter = asyncio.create_task(self.grpc_runner.wait_terminated(), name="gRPC-HybridEmbedder")
