...
class GRPCServerRunner:
    def __init__(self) -> None:
        self._context_builder_service = ContextBuilderService()
        self._servicer = ContextBuilderAPI(self._context_builder_service)
        self._max_workers: int = 4
        self._host: str = EnvTools.get_service_host("context_builder")
        self._port: int = int(EnvTools.get_service_grpc_port("context_builder"))
        ...
        context_builder_pb2_grpc.add_ContextBuilderServiceServicer_to_server(self._servicer, self._server)
