...
from src.grpc.grpc_server import GrpcContextBuilderServer
...
class Service:
    def __init__(self) -> None:
        ...
        self.grpc_runner = GrpcContextBuilderServer()
    ...
    async def run_service(self) -> None:
        ...
        waiter = asyncio.create_task(self.grpc_runner.wait_terminated(), name="gRPC-Context-Builder")
